...
public class LinkMemoriesToolTests : DatabaseTest
{
    ...
    public void LinkMemories_ShouldReturnError_WhenIdsAreNotValid()
    {
        ...
        // act
        var result = LinkMemoriesTool.Handle(ConnectionString, _faker.Random.Guid(), _faker.Random.Guid());
    ...
    public void LinkMemories_ShouldCreateLink()
    {
        ...
        // act
        var result = LinkMemoriesTool.Handle(ConnectionString, memories[0].Id, memories[1].Id);
